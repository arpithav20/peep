...
import ResourcesTab from './user/ResourcesTab';
import ProjectsTab from './user/ProjectsTab';
import SubmissionsTab from './user/SubmissionsTab';
import PlacementsTab from './user/PlacementsTab';
import MistakeCards from './user/MistakeCards';
...
const UserDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'mistakes', label: 'Mistake Cards', icon: Sparkles }
  ];
    ...
    <Layout title="Student Dashboard">
      <div className="space-y-6">
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl shadow-sm border border-gray-200 p-2 mt-8"
        >
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const videosWatched = userResourceProgressSnapshot.size;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      >
        ...
        <h3 className="font-semibold text-gray-900 mb-2">Videos Watched</h3>
